...
- **Price history is a paid feature for them** (30 days Premium, full history Elite) — mgz-pkmn doesn't currently persist historical price snapshots at all (the "30-day price-trend sparkline" is tracked as unbuilt, [#269](https://github.com/mgzwarrior/mgz-pkmn/issues/269), v1.10). Not urgent relative to R1, but worth noting that TCG Codex treats trend data as monetizable, which supports keeping mgz-pkmn's version free as a differentiator if/when it ships.
