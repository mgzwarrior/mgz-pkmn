...
**Permissions.** The workflow grants only `contents: read`, `pull-requests: write`, and `issues: write` — enough for the action to read the diff and post the review, nothing else.
